...
import com.example.tshare.model.taxi
...
class updateTaxiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        timeSpinner?.onItemSelectedListener= object : AdapterView.OnItemSelectedListener{
            ...
            override fun onNothingSelected(p0: AdapterView<*>?) {
                Toast.makeText(this@updateTaxiActivity, "Please select AM or PM", Toast.LENGTH_SHORT).show()
            }
        }
        ...
        publishBTN?.setOnClickListener {
            ...
            if (itemId != null) {
                ...
                val databaseReference = FirebaseDatabase.getInstance().getReference("taxiRequests").child(itemId)

                // Construct a Map or an object with the updated data
